...
creds = "dbfs:/FileStore/Users/andrij.demianczuk@databricks.com/tmp/ademianczuk_vch_int.share"

# COMMAND ----------

# DBTITLE 1,Let's quickly preview the credentials to make sure they're legit
# MAGIC %fs head /FileStore/Users/andrij.demianczuk@databricks.com/tmp/ademianczuk_vch_int.share
...
profile_file = '/dbfs/FileStore/Users/andrij.demianczuk@databricks.com/tmp/ademianczuk_vch_int.share'
...
profile_file = '/FileStore/Users/andrij.demianczuk@databricks.com/tmp/ademianczuk_vch_int.share'
table_url = f"{profile_file}#ademianczuk_vch_internal.hls.s_callout_augmented"
...
display(df.groupBy(df.Reason).agg(sum(df.Number_Needed).alias("Number_Needed")).orderBy("Number_Needed"))
